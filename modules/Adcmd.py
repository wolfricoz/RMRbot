...
- Excessively long list, we suggest using google docs for very long lists.
    ...
    async def adpictures(self, ctx, msgID: int):
        ...
        for channel in ctx.guild.text_channels:
            try:
                ...
                user = msg.author
                swarnings = await advert.increasewarnings(ctx, user)
                warning = """Hello, I'm a **bot** of Roleplay Meets: Reborn. I'm reaching out to you regarding your ad in {}. It's been removed for **having more than 3 images*. Please repost it with the appropriate fixes.
