...
class moderation(commands.Cog, name="rmn"):
    ...
    async def partner(self, interaction: discord.Interaction, category: Choice[str], member: discord.Member,
                      servername: str):
        await interaction.response.defer()
        bot = self.bot
        guild = interaction.guild
        category = discord.utils.get(interaction.guild.categories, id=int(category.value))
