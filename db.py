...
# sqlalchemy
# Removed: pool_size=100, max_overflow=100, pool_timeout=30, pool_recycle=120,
engine = create_engine(DBTOKEN, echo=False, echo_pool=True, pool_pre_ping=True, poolclass=NullPool)  # connects to the database
